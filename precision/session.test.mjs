...
test('dedicated GitHub Pages origin allowed',()=>assert.equal(hostPolicy('https://kokoom94-ai.github.io/jeju-now-981/').canConnect,true));
test('dedicated Netlify origin allowed',()=>assert.equal(hostPolicy('https://jeju-before-walk.netlify.app').canConnect,true));
